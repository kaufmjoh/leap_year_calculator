#This program can be run on the OSU flip servers by entering 'python err_handling_john_kaufman_hw1.py' (also works with other versions of python)

#John Kaufman CS 362 Winter 2020 HW3: Python Leap Year Calculator (WITH ERROR HANDLING)
